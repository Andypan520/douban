...
public class FetchIPUtil {
    ...
    private final static String GET_IP_URL = "http://www.xicidaili.com/api";
...
class checkIp implements Runnable {
    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(FetchIPUtil.class);
